...
if __name__=="__main__":
    ...
    print(np.unique(df_drop['tls_ext_server_name']))
    print(np.unique(df_drop['tls_scs']))
    print(np.unique(df_drop['http_content_type']))
    print(np.unique(df_drop['http_user_agent']))
    print(np.unique(df_drop['http_accept_language']))
