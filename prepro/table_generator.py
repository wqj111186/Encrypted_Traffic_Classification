...
def http_info(data, i, df):
    ...
    if data[i].__contains__("http"):
        ...
        if http.__contains__('out'):
            ...
            df.loc[i,out_col] = [k + '_NULL' for k in out_col]
    else:
        df.loc[i,http_col] = [k + '_NULL' for k in http_col]
    ...
    if data[i].__contains__("linked_dns"):
        ...
        if dns.__contains__('dns'):
            ...
            if dns['dns'][0].__contains__('rr'):
                ...
                df.loc[i,dns_col] = [k + '_NULL' for k in dns_col]
        else:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_path', type=str,
                        default='../data/csv/', dest='output_path',
                        help='Path to output')
